...
var WeekHeadColor="#3944E8";//var WeekHeadColor="#18861B";//Background Color in Week header.
var SundayColor="white";//var SundayColor="#C0F64F";//Background color of Sunday.
var SaturdayColor="white";//var SaturdayColor="#C0F64F";//Background color of Saturday.
var WeekDayColor="white";//Background color of weekdays.
var FontColor="blue";//color of font in Calendar day cell.
var TodayColor="#00FF22";//var TodayColor="#FFFF33";//Background color of today.
var SelDateColor = "#F7FF00";//var SelDateColor="#8DD53C";//Backgrond color of selected date in textbox.
var YrSelColor="#cc0033";//color of font of Year selector.
var MthSelColor="#cc0033";//color of font of Month selector if "MonthSelector" is "arrow".
var HoverColor="#F7FF00"; //color when mouse move over #E0FF38.
